...
LANGUAGE: Always respond in Simplified Chinese. Chapter titles, summaries, and quotes must all be written in Chinese.
...
{
  "chapters": [
    {"title": "章节标题", "timestamp": "0:00", "timestampSeconds": 0, "summary": "本部分内容简介"}
  ],
  "keyQuotes": [
    {"quote": "引用内容", "timestamp": "2:30", "timestampSeconds": 150}
  ],
...
- All text output must be Simplified Chinese.
```
